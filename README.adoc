...
image::../raw/master/docs/q-behave.png[]  
...
image::../raw/master/docs/q-behave-state.png[]  
...
image::../raw/master/libraries/q_learning/examples/Q_Behave_RGB_Led/Q_Behave_RGB_Led_schem.png[]  

[[img-Q_Behave_RGB_Led_bb]]
.Breadboard of RGB Diode stearing with one button only
image::../raw/master/libraries/q_learning/examples/Q_Behave_RGB_Led/Q_Behave_RGB_Led_bb.png[]  
...
If you need other license or would like to get support, please contact us.
